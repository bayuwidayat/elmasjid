...
<form action="<?php echo site_url('ladmin/tausiyah/ajax_save'); ?>" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-3">
                        <input type="text" name="judul" class="form-control" placeholder="Judul Tausiyah" required>
                    </div>
                    <div class="form-group mb-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="tag" name="tag" class="form-control" placeholder="Tag. Pisahkan dengan koma">
                    </div>
