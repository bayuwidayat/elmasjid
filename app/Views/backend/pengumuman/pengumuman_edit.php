...
<form action="<?php echo site_url('ladmin/pengumuman/ajax_update'); ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-3">
                        <input type="text" name="judul" class="form-control form-control-sm" placeholder="Judul Pengumuman" value="<?= $pengumuman->nm_pengumuman ?>" required>
                    </div>
                    <div class="form-group mb-3">
                        <textarea id="summernote" name="isi_pengumuman"><?= $pengumuman->nm_pengumuman ?></textarea>
                    </div>
                </div>
            </div><!-- /.card -->
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" value="<?= $pengumuman->file_pengumuman ?>" class="form-control form-control-sm" disabled>
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label">File Baru (jika ada)</label>
                        ...
                        <small>Silahkan upload file berekstensi .jpeg/.jpg/.png/.gif/.jiff/.xls/.xlsx/.doc/.docx/.pdf/.zip</small>
                    </div>
                    <input type="hidden" value="<?= $pengumuman->id_pengumuman ?>" id="id_pengumuman" name="id_pengumuman">
                    <input type="hidden" value="<?= $pengumuman->file_pengumuman ?>" id="gambar" name="gambar">
