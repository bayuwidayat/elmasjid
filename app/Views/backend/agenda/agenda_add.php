...
<form action="<?php echo site_url('ladmin/agenda/ajax_save'); ?>" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-3">
                        <input type="text" name="judul" class="form-control form-control-sm" placeholder="Judul Agenda" required>
                    </div>
                    <div class="form-group mb-3">
                        <textarea id="summernote" name="isi_agenda"></textarea>
                    </div>
                </div>
            </div><!-- /.card -->
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <div>
                            <div class="input-daterange input-group" id="date-range">
                                <input type="text" class="form-control form-control-sm" name="tgl_mulai" placeholder="Tgl. Mulai" value="<?= date('Y-m-d') ?>" />
                                <input type="text" class="form-control form-control-sm" name="tgl_selesai" placeholder="Tgl. Selesai" value="<?= date('Y-m-d') ?>" />
                            </div>
                    ...
                    <div class="form-group mb-3">
                        <label>Jam</label>
                        <input type="text" class="form-control form-control-sm" name="jam" placeholder="Jam Acara. Misal: 08.00 s/d 12.00 WIB" />
                    </div>
                    <div class="form-group mb-3">
                        <label>Tempat</label>
                        <input type="text" class="form-control form-control-sm" name="tempat" placeholder="Tempat Acara" />
                    </div>
                    <div class="form-group mb-3">
                        <label>Koordinator</label>
                        <input type="text" class="form-control form-control-sm" name="koordinator" placeholder="Koordinator" />
                    </div>
                    <div class="form-group mb-3">
                        <label>No Telepon</label>
                        <input type="text" class="form-control form-control-sm" name="telp_koordinator" placeholder="No Telepon" />
                    </div>
                    <div class="form-group mb-3">
