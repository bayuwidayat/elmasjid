                            ...
                            <div class="col-md-4 wow slideInUp mb-4" data-wow-delay="<?= (($i % 2) == 1) ? '0.1s' : '0.6s'; ?>">
                                <div class="blog-item bg-light rounded overflow-hidden">
                                    <div class="blog-img position-relative overflow-hidden">
                                        <img class="img-fluid" src="<?= base_url() ?>assets/images/<?= $bp['tipe'] ?>/<?= $bp['gambar'] ?>" alt="">
                                    </div>
                                    <div class="p-4">
                                        ...
                                        <a href="<?= base_url(); ?><?= $bp['tipe'] ?>/<?= $bp['id_berita']; ?>/<?= $bp['judul_seo']; ?>">Selengkapnya <i class="fas fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                    <?php
