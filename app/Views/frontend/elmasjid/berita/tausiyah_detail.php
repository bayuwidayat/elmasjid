            ...
            <div class="col-md-8">
                <div class="mb-5">
                    <?php if (!empty($berita[0]->gambar)) { ?>
                        <img class="img-fluid w-100 rounded mb-5" src="<?= base_url(); ?>assets/images/tausiyah/<?= $berita[0]->gambar; ?>" alt="<?= $berita[0]->judul; ?>" title="<?= $berita[0]->judul; ?>">
                    <?php } ?>

                    <h1 class="mb-4"><?= $berita[0]->judul; ?></h1>

                    <div class="mb-4">
                        <small class="me-3"><i class="far fa-user text-primary me-2"></i><?= $berita[0]->created_by; ?></small>
